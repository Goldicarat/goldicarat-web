        ...
        <div className="flex items-center justify-between py-3 sm:py-4">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="relative">
              ...
              >
                {user?.avatar ? (
                  <img src={user.avatar} alt="" className="w-5 h-5 sm:w-6 sm:h-6 rounded-full object-cover" />
                ) : (
          ...
          <div className="container mx-auto px-4 py-4 space-y-4">
            ...
            {isLoggedIn() && (
              <div className="pt-4 border-t space-y-2">
                ...
                <Link to="/account" onClick={handleNavClick} className="block text-sm text-gold-600 font-medium">
                  My Account
                </Link>
                <button onClick={handleLogout} className="text-red-600 font-medium text-sm">
                  Logout
                </button>
              </div>
            )}
